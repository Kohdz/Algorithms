...
# The idea is to maintain a window and keep a count of every character in the window. Whenever the size of the window is equaled to k, add it to the set.

# Time O(nk)
# Space O(nk) or (O(1))

# s O(NK) where N = length of string and K = k
